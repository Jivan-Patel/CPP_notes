...
class CreateObj{
  ...
  public:
    ...
    // Deconstructor to trace those objects which are going to destroy....
      ~CreateObj(){
          --count;
...
// It is use to initialize the static data members value....
...
void create(){
    ...
    cout <<"All object which is created is about to get destroyed because of its life scope" << endl;
}
